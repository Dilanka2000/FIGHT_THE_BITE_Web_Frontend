...
export const resetSchema = yup.object().shape({
    password: yup
        .string()
        .min(6)
        .matches(passwordRule, "Must have upper case letter, lower case letter, numaric number and special charactor")
        .required("Field Required!"),
    confirmPassword: yup
        .string()
        .required("Field Required!")
...
export const villageOfficerSchema = yup.object().shape({
    ...
    password: yup
        ...
        .matches(
            passwordRule,
            "Must have upper case letter, lower case letter, numaric number and special charactor"
        )
        .required("Field Required!"),
});
...
export const doctorSchema = yup.object().shape({
    ...
    .string()
    .required("Field Required!")
    .matches(nicRule, "Invalid NIC number!"),
    email: yup
    .string()
    .email("Invalid Email!")
    .matches(emailRule, "Invalid Email!")
